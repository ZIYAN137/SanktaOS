...
#[test_case]
fn test_ext4_create_duplicate_file() {
    // 创建 Ext4 文件系统
...
#[test_case]
fn test_ext4_create_duplicate_directory() {
    // 创建 Ext4 文件系统
    let fs = create_test_ext4();
    let root = fs.root_inode();
...
#[test_case]
fn test_ext4_truncate_directory() {
    // 创建目录
    let fs = create_test_ext4();
    let dir = create_test_dir(&fs, "testdir").unwrap();
...
#[test_case]
fn test_ext4_special_filenames() {
    // 创建 Ext4 文件系统
    let fs = create_test_ext4();
    let root = fs.root_inode();
