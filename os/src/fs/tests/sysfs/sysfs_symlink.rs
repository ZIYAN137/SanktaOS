...
#[test_case]
fn test_sysfs_block_symlink_exists() {
...
#[test_case]
fn test_sysfs_block_symlink_target() {
    let sysfs = create_test_sysfs_with_tree().unwrap();
    let root = sysfs.root_inode();
    ...
    assert!(target_path == "class/block");
}

#[test_case]
fn test_sysfs_symlink_metadata() {
    let sysfs = create_test_sysfs_with_tree().unwrap();
    let root = sysfs.root_inode();
...
#[test_case]
fn test_sysfs_symlink_not_writable() {
    let sysfs = create_test_sysfs_with_tree().unwrap();
    let root = sysfs.root_inode();
...
#[test_case]
fn test_sysfs_symlink_not_readable_as_file() {
    let sysfs = create_test_sysfs_with_tree().unwrap();
    let root = sysfs.root_inode();
