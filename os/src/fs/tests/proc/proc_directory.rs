...
#[test_case]
fn test_procfs_readdir_contains_files() {
    let procfs = create_test_procfs_with_tree().unwrap();
    let root = procfs.root_inode();
...
#[test_case]
fn test_procfs_lookup_nonexistent() {
    let procfs = create_test_procfs_with_tree().unwrap();
    let root = procfs.root_inode();
...
#[test_case]
fn test_procfs_directory_not_writable() {
    let procfs = create_test_procfs_with_tree().unwrap();
    let root = procfs.root_inode();
...
#[test_case]
fn test_procfs_directory_not_deletable() {
    let procfs = create_test_procfs_with_tree().unwrap();
    let root = procfs.root_inode();
...
#[test_case]
fn test_procfs_readdir_entry_types() {
    let procfs = create_test_procfs_with_tree().unwrap();
    let root = procfs.root_inode();
