...
#[test_case]
fn test_ramdisk_read_invalid_block() {
    let ramdisk = RamDisk::new(512, 512, 0);
...
#[test_case]
fn test_ramdisk_write_invalid_block() {
    let ramdisk = RamDisk::new(512, 512, 0);
...
#[test_case]
fn test_ramdisk_read_wrong_buffer_size() {
    let ramdisk = RamDisk::new(512, 512, 0);
...
#[test_case]
fn test_ramdisk_write_wrong_buffer_size() {
    let ramdisk = RamDisk::new(512, 512, 0);
...
#[test_case]
fn test_ramdisk_multiple_read_write() {
...
#[test_case]
fn test_ramdisk_overwrite_block() {
    let ramdisk = RamDisk::new(512, 512, 0);
